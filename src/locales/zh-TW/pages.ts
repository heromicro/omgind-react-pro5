export default {
  ...
  'pages.signin.accountSignIn.tab': '賬戶密碼登錄',
  'pages.signin.accountSignIn.errorMessage': '錯誤的用戶名和密碼(admin/ant.design)',
  ...
  'pages.signin.phoneSignIn.tab': '手機號登錄',
  'pages.signin.phoneSignIn.errorMessage': '驗證碼錯誤',
  ...
  'pages.signin.phoneSignIn.getVerificationCode': '獲取驗證碼',
