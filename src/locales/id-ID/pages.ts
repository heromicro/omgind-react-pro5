export default {
  ...
  'pages.signin.accountLogin.tab': 'Login dengan akun',
  'pages.signin.accountLogin.errorMessage': 'Nama pengguna dan kata sandi salah(admin/ant.design)',
  'pages.signin.failure': 'Log masuk gagal, silakan coba lagi!',
  'pages.signin.success': 'Login berhasil!',
  ...
  'pages.signin.phoneLogin.tab': 'Login dengan ponsel',
  'pages.signin.phoneLogin.errorMessage': 'Kesalahan kode verifikasi',
  ...
  'pages.signin.phoneLogin.getVerificationCode': 'Dapatkan kode',
