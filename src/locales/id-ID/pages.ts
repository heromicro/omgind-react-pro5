export default {
  ...
  'pages.signin.accountSignIn.tab': 'SignIn dengan akun',
  'pages.signin.accountSignIn.errorMessage': 'Nama pengguna dan kata sandi salah(admin/ant.design)',
  'pages.signin.failure': 'Log masuk gagal, silakan coba lagi!',
  'pages.signin.success': 'SignIn berhasil!',
  'pages.signin.username.placeholder': 'nama pengguna: admin atau user',
  'pages.signin.username.required': 'Nama pengguna harus diisi!',
  'pages.signin.password.placeholder': 'kata sandi: ant.design',
  'pages.signin.password.required': 'Kata sandi harus diisi!',
  'pages.signin.phoneSignIn.tab': 'SignIn dengan ponsel',
  'pages.signin.phoneSignIn.errorMessage': 'Kesalahan kode verifikasi',
  'pages.signin.phoneNumber.placeholder': 'masukkan nomor telepon',
  'pages.signin.phoneNumber.required': 'Nomor ponsel harus diisi!',
  'pages.signin.phoneNumber.invalid': 'Nomor ponsel tidak valid!',
  'pages.signin.captcha.placeholder': 'kode verifikasi',
  'pages.signin.captcha.required': 'Kode verifikasi diperlukan!',
  'pages.signin.phoneSignIn.getVerificationCode': 'Dapatkan kode',
  'pages.getCaptchaSecondText': 'detik tersisa',
  'pages.signin.rememberMe': 'Ingat saya',
  'pages.signin.forgotPassword': 'Lupa Kata Sandi?',
  'pages.signin.submit': 'Masuk',
  'pages.signin.signinWith': 'Masuk dengan :',
  'pages.signin.registerAccount': 'Daftar Akun',
