export default {
  ...
  'pages.signin.accountSignIn.tab': 'অ্যাকাউন্টে লগইন',
  'pages.signin.accountSignIn.errorMessage': 'ভুল ব্যবহারকারীর নাম/পাসওয়ার্ড(admin/ant.design)',
  'pages.signin.failure': 'লগইন ব্যর্থ হয়েছে। আবার চেষ্টা করুন!',
  'pages.signin.success': 'সফল লগইন!',
  'pages.signin.username.placeholder': 'ব্যবহারকারীর নাম: admin or user',
  'pages.signin.username.required': 'আপনার ব্যবহারকারীর নাম ইনপুট করুন!',
  'pages.signin.password.placeholder': 'পাসওয়ার্ড: ant.design',
  'pages.signin.password.required': 'আপনার পাসওয়ার্ড ইনপুট করুন!',
  'pages.signin.phoneSignIn.tab': 'ফোন লগইন',
  'pages.signin.phoneSignIn.errorMessage': 'যাচাইকরণ কোড ত্রুটি',
  'pages.signin.phoneNumber.placeholder': 'ফোন নম্বর',
  'pages.signin.phoneNumber.required': 'আপনার ফোন নম্বর ইনপুট করুন!',
  'pages.signin.phoneNumber.invalid': 'ফোন নম্বরটি সঠিক নয়!',
  'pages.signin.captcha.placeholder': 'যাচাইকরণের কোড',
  'pages.signin.captcha.required': 'দয়া করে ভেরিফিকেশন কোডটি ইনপুট করুন!',
  'pages.signin.phoneSignIn.getVerificationCode': 'কোড পান',
  'pages.getCaptchaSecondText': 'সেকেন্ড',
  'pages.signin.rememberMe': 'আমাকে মনে রাখুন',
  'pages.signin.forgotPassword': 'পাসওয়ার্ড ভুলে গেছেন?',
  'pages.signin.submit': 'প্রবেশ করুন',
  'pages.signin.signinWith': 'লগইন করতে পারেন:',
  'pages.signin.registerAccount': 'অ্যাকাউন্ট নিবন্ধন করুন',
