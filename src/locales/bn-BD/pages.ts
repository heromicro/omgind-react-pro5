export default {
  ...
  'pages.signin.accountLogin.tab': 'অ্যাকাউন্টে লগইন',
  'pages.signin.accountLogin.errorMessage': 'ভুল ব্যবহারকারীর নাম/পাসওয়ার্ড(admin/ant.design)',
  ...
  'pages.signin.phoneLogin.tab': 'ফোন লগইন',
  'pages.signin.phoneLogin.errorMessage': 'যাচাইকরণ কোড ত্রুটি',
  ...
  'pages.signin.phoneLogin.getVerificationCode': 'কোড পান',
