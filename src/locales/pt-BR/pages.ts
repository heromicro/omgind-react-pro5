export default {
  ...
  'pages.signin.accountSignIn.tab': 'SignIn da conta',
  'pages.signin.accountSignIn.errorMessage': 'usuário/senha incorreto(admin/ant.design)',
  'pages.signin.failure': 'SignIn falhou, por favor tente novamente!',
  'pages.signin.success': 'SignIn efetuado com sucesso!',
  'pages.signin.username.placeholder': 'Usuário: admin or user',
  'pages.signin.username.required': 'Por favor insira seu usuário!',
  'pages.signin.password.placeholder': 'Senha: ant.design',
  'pages.signin.password.required': 'Por favor insira sua senha!',
  'pages.signin.phoneSignIn.tab': 'SignIn com Telefone',
  'pages.signin.phoneSignIn.errorMessage': 'Erro de Código de Verificação',
  'pages.signin.phoneNumber.placeholder': 'Telefone',
  'pages.signin.phoneNumber.required': 'Por favor entre com seu telefone!',
  'pages.signin.phoneNumber.invalid': 'Telefone é inválido!',
  'pages.signin.captcha.placeholder': 'Código de Verificação',
  'pages.signin.captcha.required': 'Por favor entre com o código de verificação!',
  'pages.signin.phoneSignIn.getVerificationCode': 'Obter Código',
  'pages.getCaptchaSecondText': 'seg(s)',
  'pages.signin.rememberMe': 'Lembre-me',
  'pages.signin.forgotPassword': 'Perdeu a Senha ?',
  'pages.signin.submit': 'Enviar',
  'pages.signin.signinWith': 'SignIn com :',
  'pages.signin.registerAccount': 'Registra Conta',
