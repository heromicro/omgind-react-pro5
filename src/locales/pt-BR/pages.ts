export default {
  ...
  'pages.signin.accountLogin.tab': 'Login da conta',
  'pages.signin.accountLogin.errorMessage': 'usuário/senha incorreto(admin/ant.design)',
  'pages.signin.failure': 'Login falhou, por favor tente novamente!',
  'pages.signin.success': 'Login efetuado com sucesso!',
  ...
  'pages.signin.phoneLogin.tab': 'Login com Telefone',
  'pages.signin.phoneLogin.errorMessage': 'Erro de Código de Verificação',
  ...
  'pages.signin.phoneLogin.getVerificationCode': 'Obter Código',
  ...
  'pages.signin.signinWith': 'Login com :',
