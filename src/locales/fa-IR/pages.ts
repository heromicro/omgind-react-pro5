export default {
  ...
  'pages.signin.accountSignIn.tab': 'ورود به حساب کاربری',
  'pages.signin.accountSignIn.errorMessage': 'نام کاربری / رمزعبور نادرست (مدیر / ant.design)',
  'pages.signin.failure': 'ورود به سیستم با شکست مواجه شد، لطفا دوباره سعی کنید!',
  'pages.signin.success': 'ورود موفق!',
  'pages.signin.username.placeholder': 'نام کاربری: مدیر یا کاربر',
  'pages.signin.username.required': 'لطفا نام کاربری خود را وارد کنید!',
  'pages.signin.password.placeholder': 'رمز عبور: ant.design',
  'pages.signin.password.required': 'لطفاً رمز ورود خود را وارد کنید!',
  'pages.signin.phoneSignIn.tab': 'ورود به سیستم تلفن',
  'pages.signin.phoneSignIn.errorMessage': 'خطای کد تأیید',
  'pages.signin.phoneNumber.placeholder': 'شماره تلفن',
  'pages.signin.phoneNumber.required': 'لطفاً شماره تلفن خود را وارد کنید!',
  'pages.signin.phoneNumber.invalid': 'شماره تلفن نامعتبر است!',
  'pages.signin.captcha.placeholder': 'کد تایید',
  'pages.signin.captcha.required': 'لطفا کد تأیید را وارد کنید!',
  'pages.signin.phoneSignIn.getVerificationCode': 'دریافت کد',
  'pages.getCaptchaSecondText': 'ثانیه',
  'pages.signin.rememberMe': 'مرا به خاطر بسپار',
  'pages.signin.forgotPassword': 'رمز عبور را فراموش کرده اید ?',
  'pages.signin.submit': 'ارسال',
  'pages.signin.signinWith': 'وارد شوید با :',
  'pages.signin.registerAccount': 'ثبت نام',
