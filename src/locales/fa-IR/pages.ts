export default {
  ...
  'pages.signin.accountLogin.tab': 'ورود به حساب کاربری',
  'pages.signin.accountLogin.errorMessage': 'نام کاربری / رمزعبور نادرست (مدیر / ant.design)',
  ...
  'pages.signin.phoneLogin.tab': 'ورود به سیستم تلفن',
  'pages.signin.phoneLogin.errorMessage': 'خطای کد تأیید',
  ...
  'pages.signin.phoneLogin.getVerificationCode': 'دریافت کد',
